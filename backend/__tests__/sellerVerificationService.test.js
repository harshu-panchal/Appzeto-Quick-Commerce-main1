...
describe("sellerVerificationService", () => {
  ...
  it("does not arm the resend cooldown when the email dispatch fails (audit fix)", async () => {
    ...
    // A second attempt right away must NOT be blocked by "please wait Ns" —
    // the first attempt never actually delivered anything.
