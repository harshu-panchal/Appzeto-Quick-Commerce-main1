...
const settingSchema = new mongoose.Schema(
    {
        ...
        /** Customer header ETA label, e.g. "12-15 mins" */
        ...
        /**
         * Configurable media storage provider for NEW uploads. Existing
         * media keeps whatever provider it was originally uploaded to
         * (tracked per-file on MediaMetadata.provider) — this setting only
         * decides where the NEXT upload goes. Defaults to "cloudinary" so
         * existing deployments require zero manual DB changes.
         */
        mediaStorage: {
            provider: {
                type: String,
