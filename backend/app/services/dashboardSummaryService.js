...
import { get, set, buildKey, getTTL } from "./cacheService.js";
...
// Configuration
// Audit fix: was re-parsing CACHE_DASHBOARD_TTL independently instead of
// going through cacheService.getTTL("dashboard"), which parses the same
// env var — two sources of truth for one config value that happened to
// agree today but would silently diverge if either were edited.
const CACHE_DASHBOARD_TTL = getTTL("dashboard");
