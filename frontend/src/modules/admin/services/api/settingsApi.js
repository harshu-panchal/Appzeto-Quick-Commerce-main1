...
export const adminSettingsApi = {
    ...
    // Configurable media storage provider (Cloudinary vs local server).
    // Admin-only; affects NEW uploads only.
    getStorageSettings: () => axiosInstance.get('/admin/settings/storage'),
    updateStorageSettings: (provider) =>
        axiosInstance.put('/admin/settings/storage', { provider }),
};
