...
export const adminContentApi = {
    ...
    // Legal pages (Terms / Privacy / About / Support per audience)
    getLegalPages: () => axiosInstance.get('/admin/legal-pages'),
    getLegalPage: (audience, pageType) =>
        axiosInstance.get(`/admin/legal-pages/${audience}/${pageType}`),
    upsertLegalPage: (audience, pageType, data) =>
        axiosInstance.put(`/admin/legal-pages/${audience}/${pageType}`, data),
};
