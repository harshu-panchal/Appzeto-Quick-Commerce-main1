                    ...
                    >
                        ...
                        <div className="flex flex-col leading-tight">
                            ...
                            <div className="flex items-center gap-1 font-black text-white text-base">
                                <span className="max-w-[150px] truncate">{currentLocation?.name || "Select location"}</span> <span className="text-[10px] opacity-70">▼</span>
                            </div>
                        </div>
                    </button>
                </div>
                        ...
                        >
                            <div className="flex flex-col items-start leading-none group">
                                ...
                                <div className="flex items-center gap-1 font-bold text-slate-700 text-sm group-hover:text-[var(--primary)] transition-colors">
                                    <span className="max-w-[150px] truncate">{currentLocation?.name || "Select location"}</span> <MapPin size={14} className="fill-current" />
                                </div>
                            </div>
                        </button>
                    </div>
