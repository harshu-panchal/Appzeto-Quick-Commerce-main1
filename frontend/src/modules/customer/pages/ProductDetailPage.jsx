                ...
                <div className="lg:w-[55%] xl:w-[60%] space-y-6 md:space-y-8">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            {/* Audit fix: rating was hardcoded to "4.8" for every product
                                regardless of actual review data, falling back to a fake
                                "120+" review count when there were zero reviews — misleading
                                social proof shown platform-wide. Compute a real average from
                                the fetched reviews and hide the badge entirely when there's
                                nothing real to show, matching the "No reviews yet" empty
                                state used elsewhere on this page. */}
                            {reviews.length > 0 && (
