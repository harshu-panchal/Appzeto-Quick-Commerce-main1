    ...
    return (
      <div className="space-y-1">
        <button
          ...
          {badgeCount > 0 && (
            <span className="pointer-events-none absolute top-2 right-8 min-w-5 h-5 px-1.5 rounded-full bg-rose-500 text-white text-[10px] font-black flex items-center justify-center shadow-lg shadow-rose-500/30 ring-2 ring-[#0a0c10] z-10">
              {badgeLabel}
            </span>
          )}
          <div
